...
#region Many to Many İlişkisel Senaryolarda Veri 
...
#endregion  
#region SetNull
//Esas tablodan silinen veriyle karşı/bağımlı tabloda bulunan ilişkili verilerin null atanmasını sağlar

//One to One senaryolarda eğer ki Foreign key ve Primary key kolonları aynı ise o zaman SetNull davranışını KULLANAMAYIZ 

#endregion
#region Restrict
//Esas tablodan herhangi bir veri silinmeye çalışıldıgında o veriye karşılık dependent table'a ilişkisel veri/ler varsa eğer bu silme işleminin engellenmesini sağlar.
